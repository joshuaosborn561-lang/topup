...
insert into topup.qa_rules (rule_id, action, field, pattern, scope, reroute_to, reason) values
  ...
  ('retail_school_purge',    'purge', 'company_name', '\b(school district|isd\b|public schools|elementary|middle school|high school|walmart|target|costco|kroger|home depot|lowe''s|best buy|dollar general|7-eleven)\b', null, null, 'Retail and school districts do not fit any lane'),
  ...
  ('regulated_gift_hold',    'hold',  'company_name', '\b(bank|bancorp|credit union|fcu\b|savings and loan|trust company|federal|county of|city of|state of|department of|u\.?s\.? government)\b', null, null, 'Banks, credit unions and government cannot accept a gift; human eye before a gift campaign'),
