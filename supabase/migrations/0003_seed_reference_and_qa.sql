...
insert into topup.qa_rules (rule_id, action, field, pattern, scope, reroute_to, reason) values
  ...
  ('regulated_gift_hold',    'hold',  'company_name', '\b(bank|bancorp|credit union|fcu\b|savings and loan|trust company|federal credit union|federal savings|federal reserve|county of|city of|state of|department of|u\.?s\.? government)\b', null, null, 'Banks, credit unions and government cannot accept a gift; human eye before a gift campaign'),
